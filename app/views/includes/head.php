...
<head>
    ...
    <title>Battle heritage</title>

    <!-- Bootstrap Core CSS -->
    <link href="<?php echo Url::main()?>/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    ...
    <!-- Custom Fonts -->
    <link href="<?php echo Url::main()?>/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
